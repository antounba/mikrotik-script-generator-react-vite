        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl p-6">
          ...
          {activeTab === 'binding' && (
            <div className="space-y-6">
              <h2 className="text-lg font-bold">IP Binding Configuration</h2>

              {/* BARIS SUB-MENU 1: Pilihan Metode Binding (Hotspot vs DHCP Only) */}
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 pb-2 border-b border-slate-100 dark:border-slate-800">
